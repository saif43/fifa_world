<?php
    ...
    $query= "SELECT t2.name,t1.position,t1.salary FROM
                (
                    SELECT player_id AS id,position,salary
                    FROM player
    ...
    {
        if(isset($_POST['usalary']))
        {
            $updatedSalary=$_POST["usalary"];
            
            $sql= "UPDATE player SET salary= '$updatedSalary' WHERE player_id = '$playerid'";
...
<head>
    ...
    <title>My Club: Update Salary</title>
...
<body>
    ...
    <div class="container">
                      ...
                      <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbar-collapse-3">
                          <ul id="search_panel" class="nav navbar-nav navbar-right">
                            ...
                            <li><a id="logout"  href="login.php" style="color:white">Logout</a></li>
                            <li>
        ...
        <div>
            <h1 class="header">Update Salary</h1>
            <hr>
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <form id="form" class="box effect" method="post">
                        ...
                        <label id="csalary">Current Salary : $<?php echo $row['salary']; ?></label>
                        
                        <?php } ?>
                        <br>
                        <input name='usalary' id="usalary" class="form-control" placeholder="Update Salary" autofocus required>
                        <br>
                        <button name="Update" id="button" class="glass" type="submit" >Update</button>
                        <br><br><br>
